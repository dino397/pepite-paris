...
export const mockActivities: Activity[] = [
  ...
  },
  {
    id: 11,
    category: "activite",
    title: "Cité des Enfants 5-10 ans",
    description: "Eau, lumière, corps : des expériences scientifiques fascinantes pour les 5-10 ans. L'espace 2-7 ans est en travaux jusqu'en juin 2026.",
    date: "2025-03-29",
    location: "Cité des Sciences",
    arrondissement: "19ème",
    duration: "~1h30",
    booking_url: "https://www.cite-sciences.fr/fr/au-programme/expos-permanentes/cite-des-enfants",
    travel_walk: "45 min",
    travel_bike: "20 min",
    travel_car: "23 min",
    is_exceptional: false,
